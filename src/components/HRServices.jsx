...
export default function HRServices() {
  const services = [
    {
      ...
      description: "EBuild a strong organizational foundation through well-defined HR frameworks that drive consistency, compliance, and clarity across the workforce. Our solutions foster a resilient, engaged, and high-performing employee base—enabling long-term, sustainable growth and success.",
  ...
  return (
    <div className="w-full bg-white">
      ...
      <div className="pl-12 mb-12 pt-8">
...
function ServiceCard({ title, description, image }) {
  ...
  return (
    <div className="w-1/3 border-2 border-black rounded-lg overflow-hidden flex flex-col">
      ...
      >
        ...
        {isHovered && (
          <div className="absolute inset-0 bg-yellow-100 bg-opacity-80 p-6 flex items-center justify-center transition-all duration-300">
      ...
      <div className="bg-yellow-500 p-4 flex-1 flex items-center justify-center">
